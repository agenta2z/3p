...
from rankevolve.src.utils.string_utils.formatting.template_manager.template_manager import (
    TemplateManager,
)
from rankevolve.src.utils.string_utils.formatting.template_manager.variable_manager import (
