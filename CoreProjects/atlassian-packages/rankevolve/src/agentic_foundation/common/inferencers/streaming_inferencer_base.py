...
from rankevolve.src.agentic_foundation.common.inferencers.prompt_templates import (
...
class FallbackInferMode(enum.StrEnum):
    ...
    This is distinct from FallbackMode (in rankevolve.src.utils.common_utils.function_helper),
    ...
    See also: FallbackMode in rankevolve.src.utils.common_utils.function_helper
    """
