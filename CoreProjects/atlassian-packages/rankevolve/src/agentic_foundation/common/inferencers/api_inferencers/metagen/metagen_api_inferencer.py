...
from rankevolve.src.agentic_foundation.apis.metagen import load_model_to_key_map, MetaGenModels
from rankevolve.src.agentic_foundation.common.inferencers.api_inferencer_base import (
    ApiInferencerBase,
)
...
class MetagenApiInferencer(ApiInferencerBase):
    ...
    def __attrs_post_init__(self):
        ...
        from rankevolve.src.agentic_foundation.apis.metagen import generate_text
