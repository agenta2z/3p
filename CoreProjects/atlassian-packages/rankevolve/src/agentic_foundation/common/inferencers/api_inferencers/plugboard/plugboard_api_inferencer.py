...
class PlugboardApiInferencer(StreamingInferencerBase):
    ...
    def _infer(
        ...
        from rankevolve.src.agentic_foundation.apis.plugboard import generate_text
    ...
    async def _ainfer(
        ...
        is not needed.
        """
        from rankevolve.src.agentic_foundation.apis.plugboard import generate_text_async
    ...
    async def _ainfer_streaming(self, prompt: str, **kwargs: Any) -> AsyncIterator[str]:
        ...
        from rankevolve.src.agentic_foundation.apis.plugboard import (
