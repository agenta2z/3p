...
Usage::
    ...
    import rankevolve.src.agentic_foundation.common.configs.registered_targets  # register aliases
    from rankevolve.src.utils.config_utils import load_config, instantiate
