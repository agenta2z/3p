...
Public API:
    :class:`ToolAsInferencer` — spawn a subprocess and surface its stdout
        ...
        marker callbacks for live event extraction (epoch markers, FBLearner
        URIs, MAST job IDs, …).
...
from rankevolve.src.agentic_foundation.common.inferencers.agentic_inferencers.tool_inferencers.tool_as_inferencer import (
    make_tool_chain,
    ToolAsInferencer,
