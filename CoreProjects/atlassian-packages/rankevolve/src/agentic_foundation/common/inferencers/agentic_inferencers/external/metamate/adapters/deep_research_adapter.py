...
from rankevolve.src.agentic_foundation.common.inferencers.agentic_inferencers.external.metamate.exceptions import (
    MetamateUnavailableError,
    ResearchError,
)
from rankevolve.src.agentic_foundation.common.inferencers.agentic_inferencers.external.metamate.types import (
    Citation,
    Finding,
    MetamateConfig,
    ResearchEvent,
...
class DeepResearchAdapter:
    ...
    def _get_doc_types_for_query(self, query: ResearchQuery) -> list[str]:
        ...
        from rankevolve.src.agentic_foundation.common.inferencers.agentic_inferencers.external.metamate.types import QueryType
