...
Used by handlers that publish context-bag entries (e.g. PROPOSAL_SELECTION
posts `_selected_proposals` and `_custom_queries`; CONFIRMATION posts
...
- handlers/proposal_selection.py — selection bookkeeping
