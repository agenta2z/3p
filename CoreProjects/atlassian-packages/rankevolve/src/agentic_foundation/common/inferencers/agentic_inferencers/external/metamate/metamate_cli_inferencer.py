...
Subprocess Dependency:
    ``buck run fbcode//rankevolve.src.agentic_foundation.common.inferencers.agentic_inferencers.external.metamate:query_metamate``
    No Python import from ``rankevolve.src.agentic_foundation.common.inferencers.agentic_inferencers.external.metamate/``.
"""
...
from rankevolve.src.agentic_foundation.common.inferencers.agentic_inferencers.external.metamate.common import (
    DEFAULT_API_KEY,
    DEFAULT_TIMEOUT,
    MetamateAgent,
)
...
_BUCK_TARGET: str = "fbcode//rankevolve/src/agentic_foundation/common/inferencers/agentic_inferencers/external/metamate:query_metamate"
