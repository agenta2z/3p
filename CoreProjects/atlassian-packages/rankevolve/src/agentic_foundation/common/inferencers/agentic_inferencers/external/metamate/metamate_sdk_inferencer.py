...
from rankevolve.src.agentic_foundation.common.inferencers.agentic_inferencers.external.sdk_types import (
...
class MetamateSDKInferencer(StreamingInferencerBase):
    ...
    def _infer(
        ...
        Returns:
            ...
            ``return_sdk_response=True``.
        """
        from rankevolve.src.utils.common_utils.async_utils import _run_async
