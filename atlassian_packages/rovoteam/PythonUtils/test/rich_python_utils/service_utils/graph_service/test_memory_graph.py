...
from python_utils.service_utils.graph_service.memory_graph_service import (
    MemoryGraphService,
)
...
class TestMemoryGraphServiceNodeOperations:
...
class TestMemoryGraphServiceEdgeOperations:
...
class TestMemoryGraphServiceEdgeDirectionFiltering:
...
class TestMemoryGraphServiceCascadeDelete:
...
class TestMemoryGraphServiceGetNeighbors:
...
class TestMemoryGraphServiceListNodes:
...
class TestMemoryGraphServiceNamespaces:
...
class TestMemoryGraphServiceLifecycle:
    ...
    def test_repr(self):
        ...
        svc.add_edge(GraphEdge(source_id="n1", target_id="n2", edge_type="knows"))
        r = repr(svc)
        assert "MemoryGraphService" in r
...
class TestMemoryGraphServiceThreadSafety:
