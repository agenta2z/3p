"""
Test Producer-Consumer pattern with RedisQueueService

This demonstrates how multiple processes can use the queue service
for inter-process communication.

Tests:
- Multiple producers putting items
- Multiple consumers getting items
...
from python_utils.service_utils.queue_service.redis_queue_service import RedisQueueService
...
def run_all_tests():
    ...
    print("""
==============================================================================
              RedisQueueService Producer-Consumer Tests                       
==============================================================================

This demonstrates how RedisQueueService enables inter-process communication
