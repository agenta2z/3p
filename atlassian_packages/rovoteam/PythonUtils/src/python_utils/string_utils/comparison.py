...
from python_utils.common_utils import dedup_sequence
from python_utils.string_utils.regex import contains_whole_word
...
def string_compare(src: str, trg: Union[str, re.Pattern], option: CompareOption) -> bool:
    ...
    Examples:
        ...
        >>> from python_utils.string_utils.comparison import CompareOption, CompareMethod
