...
from python_utils.common_objects.variable_manager.base import VariableManager
from python_utils.common_objects.variable_manager.config import (
    VariableManagerConfig,
    VariableSyntax,
)
from python_utils.common_objects.variable_manager.exceptions import (
...
class FileBasedVariableManager(VariableManager):
    ...
    def get_variable(
        ...
        if self.config.merge_structured_values:
            ...
            if layers:
                from python_utils.common_utils.map_helper import _deep_merge_two
    ...
    def _get_variable_extractor(
        ...
        try:
            from python_utils.string_utils.formatting import handlebars_format
            ...
            try:
                from python_utils.string_utils.formatting import jinja2_format
            ...
            try:
                from python_utils.string_utils.formatting import (
                    python_str_format,
                )
    ...
    def get_all_variables(
        ...
        *,
        ...
        from python_utils.common_utils.map_helper import set_at_path
