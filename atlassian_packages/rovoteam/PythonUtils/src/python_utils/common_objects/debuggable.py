...
from python_utils.common_objects.identifiable import Identifiable
from python_utils.common_utils import of_type_any, iter_, get_relevant_named_args
...
def _level_print(message: str, level: int = logging.INFO):
    ...
    """
    try:
        from python_utils.console_utils import __backend__
        if __backend__ == 'rich':
            from rich.markup import escape as _rich_escape
            from python_utils.console_utils import console as _console
...
class Debuggable(Identifiable, ABC):
    ...
    def __attrs_post_init__(self):
        ...
        if self._copy_debuggable_config_from is not None:
            from python_utils.common_utils.attr_helper import copy_attrs_from
            copy_attrs_from(
    ...
    def log(self, log_item: Any, log_type: str = None, log_level: Optional[int] = None,
        ...
        Examples:
            ...
            >>> from python_utils.common_utils import dict__
            >>> import logging
