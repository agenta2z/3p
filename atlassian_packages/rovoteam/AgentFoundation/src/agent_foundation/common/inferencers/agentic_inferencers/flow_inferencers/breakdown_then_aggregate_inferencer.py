...
from python_utils.common_objects.workflow.workgraph import (
    WorkGraph,
    WorkGraphNode,
)
...
from python_utils.path_utils.path_listing import (
...
class BreakdownThenAggregateInferencer(InferencerBase, WorkGraph):
    ...
    def _build_subgraph_spec(self, sub_queries, inference_config=None, **kwargs):
        ...
        """
        from python_utils.common_objects.workflow.common.expansion import SubgraphSpec
        ...
        for i, sq in enumerate(expanded_queries):
            ...
            if isinstance(self.worker_factory, dict):
                ...
                from python_utils.config_utils._lazy_config_factory import (
                    LazyConfigFactory,
                )
