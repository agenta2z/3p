...
from python_utils.common_objects.serializable import SerializationMode
from python_utils.common_objects.workflow.common.result_pass_down_mode import (
    ResultPassDownMode,
)
from python_utils.common_objects.workflow.common.expansion import ExpansionResult
...
class LinearWorkflowInferencer(InferencerBase, Workflow):
    ...
    def _save_final_result(self, state):
        ...
        if self._workspace is None:
            return
        from python_utils.common_utils.map_helper import dict__
        from python_utils.io_utils.json_io import write_json
    ...
    def _load_final_result(self):
        ...
        if self._workspace is None:
            return None
        from python_utils.io_utils.json_io import read_json
