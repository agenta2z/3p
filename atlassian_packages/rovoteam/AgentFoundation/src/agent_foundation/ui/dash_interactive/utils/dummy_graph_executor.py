...
python_utils_src = project_root / "SciencePythonUtils" / "src"
if python_utils_src.exists() and str(python_utils_src) not in sys.path:
    sys.path.insert(0, str(python_utils_src))
elif not python_utils_src.exists():
