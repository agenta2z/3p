...
from python_utils.service_utils.data_operation_record import (
    DataOperationRecord,
    generate_operation_id,
)
from python_utils.service_utils.graph_service.graph_service_base import (
    GraphServiceBase,
)
...
class GraphServiceEntityGraphStore(EntityGraphStore):
    ...
    def supports_semantic_search(self) -> bool:
        ...
        (PythonUtils) may be at different versions.
        """
