...
# Add OpenTeam src to path for WebSocketInteractive tests
# Path: test/agent_foundation/inferencers/ -> test/ -> AgentFoundation/ -> CoreProjects/ -> OpenTeam/src
...
# ===========================================================================
# OpenTeam — run existing unit tests to ensure no regressions
# ===========================================================================
