...
_python_utils_src = _workspace_root / "SciencePythonUtils" / "src"
if _python_utils_src.exists() and str(_python_utils_src) not in sys.path:
    sys.path.insert(0, str(_python_utils_src))
