...
`agent_foundation` and `python_utils` imports resolve correctly.
"""
import sys
...
# Also add PythonUtils src to path (provides python_utils.*)
_workspace_root = _current_path.parent.parent  # CoreProjects/
_rpu_src = _workspace_root / "PythonUtils" / "src"
